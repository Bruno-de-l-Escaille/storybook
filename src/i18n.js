...
export const I18N = {
  en: {
    ...
    imageFormatError: "Unsupported format. Please use PNG or JPEG only.",
    imageSizeError: "File size exceeds 12MB. Please choose a smaller image.",
    ...
    guestDeletedSuccessfully: "Guest deleted successfully",
  ...
  fr: {
    ...
    eventEditedSuccessfully: "Événement modifié avec succès",
    ...
    imageFormatError:
      "Format non supporté. Veuillez utiliser PNG ou JPEG uniquement.",
    imageSizeError:
      "La taille du fichier dépasse 12MB. Veuillez choisir une image plus petite.",
    ...
    guestDeletedSuccessfully: "Invité supprimé avec succès",
    errorDeletingGuest: "Erreur lors de la suppression de l'invité",
  ...
  nl: {
    ...
    eventEditedSuccessfully: "Evenement succesvol bewerkt",
    errorSavingEvent: "Fout bij het opslaan van evenement",
    errorUploadingImage: "Fout bij het uploaden van de afbeelding",
    imageFormatError: "Niet-ondersteund formaat. Gebruik alleen PNG of JPEG.",
    imageSizeError:
      "Bestandsgrootte overschrijdt 12MB. Kies een kleinere afbeelding.",
    ...
    guestDeletedSuccessfully: "Gast succesvol verwijderd",
    errorDeletingGuest: "Fout bij het verwijderen van de gast",
    deleteGuest: "Gast verwijderen",
    confirmDeleteGuest: "Weet u zeker dat u deze gast wilt verwijderen",
  },
};
