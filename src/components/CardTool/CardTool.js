    ...
    return (
      <div
        className={classnames(
          styles.card_frame,
          isFavorite ? styles.card_favorite : ""
        )}
      >
        <div className={styles.card_content}>
          <div className={styles.card_header}>
            ...
            <div className={styles.card_info}>
              ...
              <div className={styles.card_info_link} style={{ color: color }}>
                <IconGlobe fill={color} /> {data.link}
              </div>
            </div>
          </div>
          ...
          <div className={styles.card_footer}>
            <div
              className={styles.card_footer_tag}
        ...
        <div className={styles.card_actions}>
          ...
          <div className={styles.card_action} onClick={() => onAddFavorite()}>
            <IconAdd width={12} height={12} />
          </div>
